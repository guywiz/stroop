...
L'expérience classique soumet de manière répétée un utilisateur à un stimulus : un mot et une couleur (d'encre utilisée pour afficher le mot). La tâche de l'utilisateur consiste à demander à l'utilisateur d'indiquer la couleur utilisée pour afficher le mot.
