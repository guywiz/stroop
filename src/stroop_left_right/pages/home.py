...
layout = html.Div(
    ...
    children=[
        ...
        html.P("En appuyant sur la barre d'espace, un mot sera affiché à l'écran."),
        html.P('Votre tâche consiste à indiquer si le mot affiché se trouve à gauche ou à droite de l\'écran.'),
