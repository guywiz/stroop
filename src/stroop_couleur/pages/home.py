...
dash.register_page(
    __name__,
    path="/",
    title="Accueil – Stroop classique"
)
...
layout = html.Div(
    ...
    children=[
        html.H1("Expérience de Stroop (classique)"),

        html.P('En cliquant sur le bouton "Nouveau mot", un mot sera affiché à l\'écran.'),
        html.P('Votre tâche consiste à indiquer la couleur de ce mot en cliquant sur le bouton approprié.'),
