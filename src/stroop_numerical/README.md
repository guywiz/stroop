...
L'expérience soumet de manière répétée un utilisateur à un stimulus : deux nombres sont affichés à l'écran, uitlisant des tailles de police différentes (l'un d'eux est plus "grand" en taille). La tâche de l'utilisateur consiste à indiquer quel nombre est le plus grand (en magnitude) en tapant un touche au clavier: "F" si le nombre le plus grand est à gauche, "J" sinon.
...
L'image ici montre un cas de stimuli *congruents*.

---

<img src="./screenshot_stroop_numerical.png" width="60%">
